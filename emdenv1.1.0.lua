...
local noclipEnabled = false -- Mặc định tắt, bật/tắt bằng phím N
local character = player.Character or player.CharacterAdded:Wait()
local humanoidRootPart = character and character:FindFirstChild("HumanoidRootPart")
local toggleKeyNoclip = Enum.KeyCode.N -- Phím tắt mặc định là N

-- Create Window
local KavoUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = KavoUI.CreateLib("Emergency Emden Script (BETA) | By Grok", "Synapse")
...
-- Create Section
local Info = Welcome:NewSection("Information") -- Sửa lỗi chính tả: Infomation -> Information
...
MainSection:NewButton("Fly", "Press `O` to fly", function()
    ...
    local humanoidRootPart = character and character:FindFirstChild("HumanoidRootPart")
    local flySpeed = 100 
    local toggleKey2 = Enum.KeyCode.O 
